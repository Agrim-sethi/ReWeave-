          ...
          <div className="bg-gradient-to-br from-accent-pink/10 via-transparent to-accent-green/10 border border-accent-pink/30 rounded-[2.5rem] p-8 md:p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendations.slice(0, 3).map((rec) => (
                ...
                >
                  {/* Match Score Badge */}
                  <div className="absolute top-4 right-4 z-10 flex items-center gap-1 bg-black/60 backdrop-blur-sm px-3 py-1.5 rounded-full">
                    <span className="material-symbols-outlined text-accent-pink text-sm">star</span>
                    <span className="text-xs font-bold text-white">{rec.matchScore}% Match</span>
                  </div>
